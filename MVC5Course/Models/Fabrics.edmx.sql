...
-- --------------------------------------------------
-- Date Created: 10/16/2016 16:56:31
-- Generated from EDMX file: C:\Users\admin\Source\Repos\MVC5Course\MVC5Course\Models\Fabrics.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[FabricsModelStoreContainer].[vw_ClientContribution]', 'U') IS NOT NULL
    DROP TABLE [FabricsModelStoreContainer].[vw_ClientContribution];
GO
...
-- Creating table 'vw_ClientContribution'
CREATE TABLE [dbo].[vw_ClientContribution] (
    [ClientId] int IDENTITY(1,1) NOT NULL,
    [FirstName] varchar(40)  NULL,
    [LastName] varchar(40)  NULL,
...
-- Creating primary key on [ClientId] in table 'vw_ClientContribution'
ALTER TABLE [dbo].[vw_ClientContribution]
ADD CONSTRAINT [PK_vw_ClientContribution]
    PRIMARY KEY CLUSTERED ([ClientId] ASC);
GO
